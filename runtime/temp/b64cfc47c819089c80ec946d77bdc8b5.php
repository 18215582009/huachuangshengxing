<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:97:"/Applications/xampp/xamppfiles/htdocs/huachuang/public/../application/admin/view/login/login.html";i:1547542403;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <![endif]-->
    <title>华创盛星-管理后台登录页面</title>
    <meta name="keywords" content="H-ui.admin">
    <meta name="description" content="H-ui.admin">
    <style type="text/css">
      .header{background: #426374;font-size: 24px !important;line-height: 60px;text-align: center;color: #fff;letter-spacing: 8px;}
    </style>
</head>
<body>
<input type="hidden" id="TenantId" name="TenantId" value="" />
<div class="header">华创盛星管理后台</div>
...
<div class="footer">Copyright 成都华创盛星网络科技有限公司 by H-ui.admin v3.1</div>
